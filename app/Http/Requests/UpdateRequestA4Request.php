...
class UpdateRequestA4Request extends FormRequest
{
    /**
     * Determine if the user is authorized to make this request.
     * Additional authorization (frozen check) is done in the Policy.
     */
    ...
    /**
     * Build a conditional 'required' rule based on the selected priority flag.
     *
     * @return string
     */
